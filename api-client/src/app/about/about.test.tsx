...
const localeMessages = {
  About: {
    ...
    projectHeading: 'Our project: AI Team API Client',
    projectDesc:
      'Our project includes a RESTfull and GraphiQL client that will allow you to conveniently work with a variety of APIs present on the web. Also, for quick access, the application is designed to save all requests in the history. The project was implemented as part of the RSSchool React course.',
    courseHeading: 'About school and course:',
    courseDesc:
      'RS School offers a unique learning experience as a free, community-based online education initiative. The RS School has been run by the Rolling Scopes community since 2013. Today, over 600 developer-volunteers from various countries and companies assist as mentors. We believe in important ideas that guide our mission. RS School React course is a great opportunity to learn about the React library, as well as frameworks that use React.',
  },
};
